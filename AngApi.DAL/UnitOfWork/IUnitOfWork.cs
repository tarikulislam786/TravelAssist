...
namespace AngApi.DAL.UnitOfWork
{
    public interface IUnitOfWork
    {
        ...
        ITouristPlaceRepository TouristPlaceViewModel { get; }
    ...
    public class UnitOfWork : IUnitOfWork
    {
      ...
      //  private IEmployeeRepository _Employee;
        private ITouristPlaceRepository _TouristPlace;
        ...
        public ITouristPlaceRepository TouristPlaceViewModel
        {
            get
            {
                if (this._TouristPlace == null)
                {
                    this._TouristPlace = new TouristPlaceRepository(_context);
                }
                return this._TouristPlace;
            }
        }
        public int Complete()
        {
